...
if( !empty($_POST) ){
    ...
    if ( empty($errors) ) {
        ...
        $sql = "INSERT INTO distribuciones (Nombre,Imagen,TipodeSistemaOperativo,Basado,Origen,Arquitectura,Escritorio,Categoria,Estado,Version,Web,Doc,Foro,Trakererror,Descripcion) VALUES (:Nombre, :Imagen, :TipodeSistemaOperativo, :Basado, :Origen, :Arquitectura, :Escritorio, :Categoria, :Estado, :Version, :Web, :Doc, :Foro, :Trakererror, :Descripcion)";
  ...
  <body>
    ...
    <form action="add.php" method="post">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="TipodeSistemaOperativo" id="TipodeSistemaOperativo">
		...
		<div class="form-group">
            ...
            <select class="form-control" name="Basado" id="Basado" multiple>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="Foro" name="Foro" >
        </div>

        <div class="form-group">
            <label for="Trakererror">Trakererror</label>
            <input type="text" class="form-control" id="Trakererror" name="Trakererror" >
        </div>
